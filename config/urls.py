...
from sensor_portal.sensors.views import (
    SensorViewSet, MetricViewSet, ReadingViewSet, sensor_map, sensor_list,
    sensor_metrics
)
...
urlpatterns = [
                  ...
                  url(r'{}docs/'.format(settings.ADMIN_URL), include('django.contrib.admindocs.urls')),

                  url(r'{}password_reset/$'.format(settings.ADMIN_URL), auth_views.password_reset,
                      name='admin_password_reset'),
                  url(r'{}password_reset/done/$'.format(settings.ADMIN_URL), auth_views.password_reset_done,
